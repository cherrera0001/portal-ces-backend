...
const schema = new mongoose.Schema(
  {
    ...
    customer: {
      ...
      id: { type: Number, required: false },
      identificationTypeId: { type: Number, required: false },
      documentSerialNumber: { type: String, required: false },
      name: { type: String, required: false },
      ...
      geographicDataId: { type: Number, required: false },
      gender: { type: String, required: false },
      createdAt: { type: Date, required: false },
      updatedAt: { type: Date, required: false },
      deletedAt: { type: Date, required: false },
      geographicData: { type: Object },
      nationalityData: { type: Object },
      genderData: { type: Object },
    },
